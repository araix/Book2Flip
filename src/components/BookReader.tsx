...
export const BookReader: React.FC<BookReaderProps> = ({ bookData }) => {
  ...
  return (
    <div className={`relative w-full h-screen bg-gradient-to-br ${backgrounds.app.gradient} overflow-hidden ${isFullscreen ? 'fullscreen' : ''}`}>
      {/* Background texture */}
      <div 
        className="absolute inset-0 opacity-10" 
        style={{ 
          backgroundImage: backgrounds.app.texture,
          opacity: backgrounds.app.textureOpacity
        }}
      ></div>
